// User Data
const user = { userid : 1, username : "newuser", tagname : "@newuser", password : "null", followers : 10, following : 11 }
const themes = {
    default:{
        background: "white",
        boxcolor: "white",
        extracolor: "rgba(255, 182, 214, 1)",
        secondarycolor: "linear-gradient(45deg, rgba(255, 182, 214, 1) 0%, rgba(165, 206, 255, 1) 100%)",
        shadowcolor: "rgba(0, 0, 0, 0.1)",
        alertcolor: "rgb(255, 64, 64)",
    },
    dark:{
        background: "black",
        boxcolor: "black",
...
function generateUser() {
    ...
    user.tagname = "@" + adjective[Math.floor(Math.random() * adjective.length)]
    // btoa() to encode atob() to decode
    user.password = btoa(user.username) 
